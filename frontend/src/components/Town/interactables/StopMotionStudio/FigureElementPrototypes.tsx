...
const personFigureTorso: FigureElement = {
  ...
  export const PERSON_FIGURE_PROTO = [personFigureHead, personFigureLeftLeg, personFigureRightLeg, personFigureLeftArm, personFigureRightArm, personFigureTorso];

  export const ANIMAL_FIGURE_PROTO = [animalFigureHead, animalFigureLeg1,animalFigureLeg2,animalFigureLeg3,animalFigureLeg4, animalFigureTorso];