...
import StopMotionGame from './StopMotionGame';

/**
 * A StopMotionGameArea is a GameArea that hosts a StopMotionGame.
 * @see StopMotionGame
 * @see GameArea
 */
export default class StopMotionGameArea extends GameArea<StopMotionGame> {
